...
const Work = forwardRef((props, ref) => {
    ...
    const PROJECT_LIST = [
        ...
        { id: 6, 'category': 'Blog', 'title': 'BOM & DOM', 'img': '/project/dombom.jpg', 'detail': 'BOM과 DOM에 대한 이해', 'url': 'https://velog.io/@jchan715/BOM%EA%B3%BC-DOM%EC%97%90-%EB%8C%80%ED%95%9C-%EC%9D%B4%ED%95%B4' },
        { id: 7, 'category': 'Blog', 'title': 'useRef', 'img': '/project/React.jpeg', 'detail': 'useRef 사용법', 'url': 'https://velog.io/@jchan715/React-useRef%EB%A5%BC-%EC%9D%B4%EC%9A%A9%ED%95%98%EC%97%AC-%EC%9B%90%ED%95%98%EB%8A%94-%EC%BB%B4%ED%8F%AC%EB%84%8C%ED%8A%B8-%EC%9C%84%EC%B9%98%EB%A1%9C-%EC%8A%A4%ED%81%AC%EB%A1%A4-%EC%9D%B4%EB%8F%99%EC%8B%9C%ED%82%A4%EA%B8%B0' },
        { id: 8, 'category': 'React', 'title': '레스토랑 WooDy', 'img': '/project/resaurantCover.png', 'detail': '예약 가능한 레스토랑 사이트', 'url': 'https://github.com/JeonWoongchan/restaurant' },
        { id: 9, 'category': 'React', 'title': '커뮤니티OTT', 'img': '/project/ottCover.png', 'detail': '디즈니플러스 클론코딩 + 커뮤니티', 'url': 'https://github.com/JeonWoongchan/BomBomOTT' },
        { id: 10, 'category': 'React', 'title': 'Weather Life', 'img': '/project/weatherCover.png', 'detail': '날씨 정보 제공 사이트', 'url': 'https://github.com/JeonWoongchan/weatherLife' },
        { id: 11, 'category': 'NextJs', 'title': 'NextJS Practice', 'img': '/project/forumCover.png', 'detail': 'NextJS 연습용 게시판', 'url': 'https://github.com/JeonWoongchan/NextJsPractice' }]
